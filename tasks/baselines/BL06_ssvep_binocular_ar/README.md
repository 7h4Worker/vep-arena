...
Ke et al. 2025 binocular AR SSVEP dataset task. This task runs paper-aligned
subject-specific leave-one-block-out CCA/FBCCA/TRCA/ETRCA experiments on the
epoch zip data under `D:/ProjData/datasets/ssvep_binocular_ar`.
