# M03_strca — sTRCA 实现任务

## 目标
在 vep_arena 实现 sTRCA 方法，并在 Benchmark/BETA 上复现论文结果。

## 论文
Measurement (2024), DOI 10.1016/j.measurement.2024.114959
...
## 实现要求
1. 新增 `vep_arena/methods/strca.py`，实现 `class sTRCA`：
...
3. 新建任务脚本 `tasks/methods/M03_strca/run.py`（参考 `tasks/baselines/BL01_ssvep_benchmark/run.py` 的 make_model 模式）
