...
# ── Binocular AR paths ──
BINO_ROOT = Path("D:/ProjData/proj_python/vep_arena/tasks/ssvep_binocular_ar_trca/results")
...
# ── JFPM paths ──
JFPM_ROOT = Path("D:/ProjData/proj_python/vep_arena/tasks/cvep_nbrs_jfpm_tsinghua_2024_baselines/results")
