"""Extended CCA for subject-specific SSVEP recognition.

Reference
---------
Nakanishi M, Wang Y, Wang Y-T, Jung T-P. A Comparison Study of Canonical
Correlation Analysis Based Methods for Detecting Steady-State Visual Evoked
Potentials. PLOS ONE. 2015. doi:10.1371/journal.pone.0140703.

Implementation identity
-----------------------
The four signed-squared correlation terms follow the paper implementation used
by the public SSVEP Analysis Toolbox. Arena adds a filter-bank input contract
and combines per-band scores with the usual FBCCA weights; that wrapper is an
Arena integration choice rather than an additional claim from the eCCA paper.
"""
